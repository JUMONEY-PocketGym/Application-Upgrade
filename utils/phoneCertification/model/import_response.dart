...
IamPortResponse iamPortResponseFromJson(String str) => IamPortResponse.fromJson(json.decode(str));

String iamPortResponseToJson(IamPortResponse data) => json.encode(data.toJson());
...
class IamPortResponse {
  ...
  factory IamPortResponse.fromJson(Map<String, dynamic> json) => IamPortResponse(
