...
AuthSnsUserCheckResponse authSnsUserCheckResponseFromJson(String str) => AuthSnsUserCheckResponse.fromJson(json.decode(str));

String authSnsUserCheckResponseToJson(AuthSnsUserCheckResponse data) => json.encode(data.toJson());
...
class AuthSnsUserCheckResponse {
  ...
  factory AuthSnsUserCheckResponse.fromJson(Map<String, dynamic> json) => AuthSnsUserCheckResponse(
        ...
        user: json["user"] == null ? null : AuthSnsUserCheckResponseUser.fromJson(json["user"]),
      );
...
class AuthSnsUserCheckResponseUser {
  ...
  factory AuthSnsUserCheckResponseUser.fromJson(Map<String, dynamic> json) => AuthSnsUserCheckResponseUser(
