...
class StepsGraphChartPage extends StatefulWidget {
  final DateTime startDate;
  final double maxDailySteps;
  final double maxOverallSteps;
  final DateTime endDate;
  final SamsungSoloDetailPageBeforeController controller;
  final bool? end;
  const StepsGraphChartPage({super.key, required this.startDate, required this.endDate, required this.maxDailySteps, required this.maxOverallSteps, required this.controller, this.end});

  @override
  State<StepsGraphChartPage> createState() => _StepsGraphChartPageState();
}

class _StepsGraphChartPageState extends State<StepsGraphChartPage> {
